...
Output fields (all OPTIONAL — omit any you cannot confidently determine):
  ...
  subject            — from the list above
  patrol_name        — ONLY for a specific named combat patrol box
  munitorum_faction  — ONLY for points-cost queries
...
Examples:
  ...
  "Librarius Conclave rules"        -> {"subject": "space marines", "doc_type": "faction_pack"}
  "How does overwatch work?"        -> {"doc_type": "core_rules"}
  "Nemesis Dreadknight points"      -> {"doc_type": "points_costs", "munitorum_faction": "grey knights"}
